        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="Vistas/suma.php">Suma</a>
                        <a class="dropdown-item" href="Vistas/resta.php">Resta</a>
                        <a class="dropdown-item" href="Vistas/multiplicacion.php">Multiplicacion</a>
                        <a class="dropdown-item" href="Vistas/division.php">Division</a>
